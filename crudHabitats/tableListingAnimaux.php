...
<body>
    ...
    <section class="container my-5 mt-4">
        ...
        <a class="btn btn-outline-success" href="formCreateHabitats.php" role="button">Ajouter nouvau animal</a>
        <br>
        <hr>
            ...
            <tbody>
                ...
                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>
                        ...
                        <td>
                            <a href='formUpdateVeterinaires.php?id_employe={$row['id_habitat']}' class='link-warning'><i class='fas fa-pencil-square'></i></a>&nbsp
