...
<body>
    ...
    try {
        // Créer la table HabitatsBis si elle n'existe pas déjà
        $createTableHabitats = "CREATE TABLE IF NOT EXISTS HabitatsBis (
        ...
        echo "La table HabitatsBis a été créée avec succès.<br>";

        // Créer la table habitat_imageBis
        $createTableImage = "CREATE TABLE IF NOT EXISTS habitat_imageBis (
        ...
        echo "La table habitat_imageBis a été créée avec succès.";
    } catch (PDOException $e) {
